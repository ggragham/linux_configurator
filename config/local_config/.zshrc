...
plugins=(git zsh-syntax-highlighting compleat cp command-not-found zsh-autosuggestions colored-man-pages docker docker-compose aws kubectl minikube vagrant terraform pip)
...
# export SSH_KEY_PATH="~/.ssh/srv_rsa"
